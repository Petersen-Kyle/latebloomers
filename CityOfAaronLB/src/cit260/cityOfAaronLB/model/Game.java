...
public class Game implements Serializable {
    ...
    public int getHarvestReturn() {
        return harvestReturn;
    }

    public void setHarvestReturn(int harvestReturn) {
        this.harvestReturn = harvestReturn;
    }
