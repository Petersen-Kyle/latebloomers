...
public enum Adjustments {
    ...
    spear("Weapon", "Spear", (int) (Math.random() * (20 + 1)) + -10, "The spear has confused itself as a magical sphere and begins to tell the future and grants wishes.", "The spear lies about its whereabouts last night. Wheat is lost from the storehouse."),
    ...
    mouse("Animal", "Mouse", (int) (Math.random() * (2 + 1)) + -1, "The mouse found out he has a distant cousin a few farms over. Wheat is added to the storehouse.", "The mouse had babies with his friends, cousins, aunts, uncles, next door neighbors, son. Wheat is lost from your storehouse."),
    ...
    rulersCourt("Rulers Court", "place of refuge", 10, "The Rulers Court is a place of refuge. You gain 10 wheat for gathering your people to safety.", "The Rulers Court is a place of refuge.");
